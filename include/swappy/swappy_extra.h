...
// If App wants to override the swap interval calculated by swappy it can call below function.
// Swappy will set swap interval to the overridden value and reset its frame timings.
