 ...
 * `SwappyGL_enableBlockingWait(swapchain, false)` will ensure that ::SwappyVk_queuePresent returns
 ...
 * called, then the previous frames GPU time will be returned otherwise `-1`
