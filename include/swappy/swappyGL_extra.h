...
/**
 * The maximum number of refresh periods for which stats are stored for frames.
 * @see SwappyStats
 */
...
/**
 * @brief If an app wishes to use the Android choreographer to provide ticks to Swappy, it can
 * call this function.
 *
 * @warning This function *must* be called before the first `Swappy_swap()` call.
...
struct SwappyStats {
    ...
    /** @brief Histogram of the number of screen refreshes a frame waited in the compositor queue after
    ...
    /** @brief Histogram of the number of screen refreshes passed between the requested presentation time
    ...
    */
    ...
    /** @brief Histogram of the number of screen refreshes passed between two consecutive frames
     *
     * For example:
    ...
    /** @brief Histogram of the number of screen refreshes passed between the call to
