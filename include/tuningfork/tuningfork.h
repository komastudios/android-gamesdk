 ...
 *  Frame time: min(64, the maximum number of annotation + instrument key
 * combinations). Loading time: 32 Memory: 15 possible memory metrics.
 */
 ...
 * @param[out] handle A handle generated by startRecordingLoadingTime
 **/
