...
void swappy_trace_test_postWait(void* userData, int64_t cpu_time_ns, int64_t gpu_time_ns) {
...
void swappy_trace_test_postSwapBuffers(void* userData, int64_t desiredPresentationTimeMillis){
  DbgMsg("swappy_trace_test_postSwapBuffers: %ld", (long)desiredPresentationTimeMillis);
}
void swappy_trace_test_startFrame(void* userData, int currentFrame, int64_t desiredPresentationTimeMillis){
...
static void demo_prepare_buffers(struct demo *demo) {
    ...
    DbgMsg("Swappy swap interval = %" PRIu64 " ns", SwappyVk_getSwapIntervalNS());
