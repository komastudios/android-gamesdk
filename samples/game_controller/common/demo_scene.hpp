...
#ifndef gamecontrollersample_demo_scene_hpp
#define gamecontrollersample_demo_scene_hpp
...
protected:
    ...
    void RenderControllerPanel_ControlsTab(const int32_t controllerIndex, const Paddleboat_Controller_Data& controllerData, const Paddleboat_Controller_Info& controllerInfo);

    void RenderControllerPanel_ControlsTab_ArcadeStick(const int32_t controllerIndex, const Paddleboat_Controller_Data& controllerData, const Paddleboat_Controller_Info& controllerInfo);

    void RenderControllerPanel_InfoTab(const int32_t controllerIndex, const Paddleboat_Controller_Data& controllerData, const Paddleboat_Controller_Info& controllerInfo);

    void RenderControllerPanel_VibrationTab(const int32_t controllerIndex, const Paddleboat_Controller_Data& controllerData, const Paddleboat_Controller_Info& controllerInfo);
