...
public class AGDKTunnelActivity extends GameActivity {
    ...
    static {
        ...
        // Optional: reload the native library. But this is necessary when any of the following happens:
        ...
        //     - GameActivity derived class calls to the native code before calling super.onCreate().
