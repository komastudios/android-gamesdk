...
public class PGSManager {
    ...
    public native void loadCloudResult(int result, int level);
    ...
    void loadCheckpoint() {
        Log.i(TAG, "scheduling loading data task");
        loadSnapshot().getResult();
    }
            ...
            .addOnFailureListener(new OnFailureListener() {
                ...
                public byte[] then(@NonNull Task<SnapshotsClient.DataOrConflict<Snapshot>> task)
                    ...
                    try {
                        ...
                        Log.i("RUVALCABAC FLAG", "level to load:" + level);

                        int RESULT_OK = 0;
                        loadCloudResult(RESULT_OK, level);
