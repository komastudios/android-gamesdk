...
#ifndef agdktunnel_ui_scene_hpp
#define agdktunnel_ui_scene_hpp
...
protected:
    ...
    // presses the "confirm" button (usually DPAD_CENTER or the ENTER key on a
    // keyboard).
...
public:
    ...
    void SetInputSdkContext() {
        NativeEngine::GetInstance()->SetInputSdkContext(UI_SCENE_CONTROLS);
    }
