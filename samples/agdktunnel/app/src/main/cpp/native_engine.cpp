...
DataLoaderStateMachine *NativeEngine::LoadProgress() {
...
void NativeEngine::SaveCloudData(int level) {
...
extern "C" void Java_com_google_sample_agdktunnel_PGSManager_savedStateLoadingCompleted(
    ...
    NativeEngine *instance= NativeEngine::GetInstance();
    instance->mDataStateMachine->savedStateLoadingCompleted(level);
}
...
DataLoaderStateMachine *NativeEngine::GetDataStateMachine() {
    return mDataStateMachine;
}
