...
// for an experiment
// Assume we don't compile in the user's proto, but have access to the file at runtime
...
int main(int argc, char *argv[]) {
  ...
  std::cerr << "Found " << exts.size() << " extensions of " << FIDELITYPARAMS << " in " << descs.back()->name() << " and its dependencies" << std::endl;
