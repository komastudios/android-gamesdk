...
JNIEXPORT void JNICALL
Java_com_tuningfork_experimentsdemo_TFTestActivity_clearSurface(JNIEnv */*env*/, jclass /*clz*/ ) {
...
JNIEXPORT void JNICALL
Java_com_tuningfork_experimentsdemo_TFTestActivity_setFidelityParameters(JNIEnv * env, jclass clz) {
