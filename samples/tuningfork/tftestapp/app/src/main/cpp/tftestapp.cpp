...
Java_com_google_demoapp_TFTestActivity_initTuningFork(JNIEnv *env, jobject activity) {
    ...
    if (swappy_enabled) {
        ...
        err = TuningFork_getFidelityParameters(env, activity, defaultFP, &fps, 1000);
        if (err == TFERROR_OK) {
...
JNIEXPORT void JNICALL
Java_com_google_demoapp_TFTestActivity_onChoreographer(JNIEnv */*env*/, jclass clz, jlong /*frameTimeNanos*/) {
...
JNIEXPORT void JNICALL
Java_com_google_demoapp_TFTestActivity_resize(JNIEnv *env, jclass /*clz*/, jobject surface, jint width, jint height) {
...
JNIEXPORT void JNICALL
Java_com_google_demoapp_TFTestActivity_clearSurface(JNIEnv */*env*/, jclass /*clz*/ ) {
    Renderer::getInstance()->setWindow(nullptr, 0, 0);
}
JNIEXPORT void JNICALL
Java_com_google_demoapp_TFTestActivity_start(JNIEnv */*env*/, jclass /*clz*/ ) {
    Renderer::getInstance()->start();
}
JNIEXPORT void JNICALL
Java_com_google_demoapp_TFTestActivity_stop(JNIEnv */*env*/, jclass /*clz*/ ) {
