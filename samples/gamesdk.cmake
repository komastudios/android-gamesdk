...
#  ROOT_DIR: where the gamesdk directory is located, relative to the CMake file calling the function.
#    default value: the parent folder of this file.
#  PACKAGE_DIR: where the packaged version of the library is, relative to the gamesdk root dir.
#    default value: ../package/gamesdk
#  GEN_TASK: the gradle task to build the package (if DO_LOCAL_BUILD was specified).
#    default value: none (this must be specified in DO_LOCAL_BUILD is set).
...
function(add_gamesdk_target)
    ...
    # Set up folder paths
    if(NOT DEFINED GAMESDK_ROOT_DIR)
        set(GAMESDK_ROOT_DIR "${_MY_DIR}/..")
    endif()
    if(NOT DEFINED GAMESDK_PACKAGE_DIR)
        set(GAMESDK_PACKAGE_DIR "../package/gamesdk")
    endif()

    # Make sanity checks to avoid hard to debug errors at compile/link time.
    get_filename_component(INCLUDE_FULL_PATH "${GAMESDK_ROOT_DIR}/${GAMESDK_PACKAGE_DIR}/include/" REALPATH)
    if (NOT GAMESDK_DO_LOCAL_BUILD AND NOT EXISTS ${INCLUDE_FULL_PATH})
        message(FATAL_ERROR "Can't find the gamesdk includes in ${INCLUDE_FULL_PATH}. Are you sure you properly set up the path to the Game SDK using GAMESDK_ROOT_DIR and GAMESDK_PACKAGE_DIR?")
    endif()
    ...
    set(GAMESDK_LIB_DIR "${GAMESDK_ROOT_DIR}/${GAMESDK_PACKAGE_DIR}/libs/${BUILD_NAME}")

    include_directories( "${GAMESDK_ROOT_DIR}/${GAMESDK_PACKAGE_DIR}/include" ) # Games SDK Public Includes
