    ...
    if(GAMESDK_DO_LOCAL_BUILD)
        ...
        add_custom_command(
            OUTPUT
                ${DEP_LIB}
            COMMAND
                ${GAMESDK_GRADLE_BIN} ${GAMESDK_GEN_TASK} -PGAMESDK_ANDROID_API_LEVEL=${GAMESDK_ANDROID_API_LEVEL} -PGAMESDK_BUILD_TYPE=${GAMESDK_BUILD_TYPE} -PGAMESDK_ANDROID_NDK_REVISION=${ANDROID_NDK_REVISION}
            VERBATIM
            WORKING_DIRECTORY
                "${GAMESDK_ROOT_DIR}"
        )
