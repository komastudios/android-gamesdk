    ...
    if(GAMESDK_DO_LOCAL_BUILD)
        ...
        add_custom_command(
            OUTPUT
                ${DEP_LIB}
            COMMAND
                ${CMAKE_COMMAND} -E env ANDROID_NDK_REVISION=${GAMESDK_ANDROID_NDK_VERSION} ${GAMESDK_GRADLE_BIN} ${GAMESDK_GEN_TASK} -PandroidApiLevel=${GAMESDK_ANDROID_API_LEVEL} -PbuildType=${GAMESDK_BUILD_TYPE}
            VERBATIM
            WORKING_DIRECTORY
                "${GAMESDK_ROOT_DIR}"
        )
