...
JNIEXPORT void JNICALL
Java_com_prefabulated_bouncyball_OrbitActivity_nSetDoubleBufferFixWait(JNIEnv * /* env */,
                                                            jobject /* this */,
                                                            jint n_frames) {
...
JNIEXPORT void JNICALL
Java_com_prefabulated_bouncyball_OrbitActivity_nDisableSwappy(JNIEnv * /* env */,
                                                              jobject /* this */,
                                                              jboolean tf) {
