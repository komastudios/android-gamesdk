...
import com.google.wireless.android.finsky.dfe.GameSdkDeviceInfoProto;
import com.google.wireless.android.finsky.dfe.GameSdkDeviceInfoProto.GameSdkDeviceInfoWithErrors;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sample_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    GameSdkDeviceInfoWithErrors proto;
                    byte[] nativeBytes = GameSdkDeviceInfoJni.tryGetProtoSerialized();
                    proto = GameSdkDeviceInfoWithErrors.parseFrom(nativeBytes);
