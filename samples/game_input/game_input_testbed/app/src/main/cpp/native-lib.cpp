...
// Also include the source of Game Input in one of your C++ file, so that the library
// is compiled as part of your build:
...
Java_com_gameinput_testbed_MainActivity_onCreated(JNIEnv* env, jobject thiz) {
    ...
    setDisplayedText = env->GetMethodID(activityClass, "setDisplayedText", "(Ljava/lang/String;)V");
...
extern "C"
JNIEXPORT void JNICALL
Java_com_gameinput_testbed_InputEnabledTextView_onTextInputEventNative(JNIEnv* env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_gameinput_testbed_MainActivity_setInputConnectionNative(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_gameinput_testbed_MainActivity_sendSelectionToStart(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_gameinput_testbed_MainActivity_sendSelectionToEnd(JNIEnv *env, jobject thiz) {
    const GameInputState* state = GameInput_getState(gameInput);
    GameInputState *state_copy = (GameInputState*)malloc(sizeof(GameInputState));
    GameInputState_constructEmpty(state_copy);
    GameInputState_set(state_copy, state);
