...
void main() {
    ...
    fragLightBlock.pointLight = lightBlock.pointLight;
    fragLightBlock.ambientLight = lightBlock.ambientLight;
    fragLightBlock.pointLight.position = worldToTangent * lightBlock.pointLight.position;
