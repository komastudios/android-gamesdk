...
//void MeshRenderer::Update(uint_t frame_index, glm::vec3 camera, glm::mat4 view, glm::mat4 proj, glm::mat4 prerotation) {
...
void MeshRenderer::SubmitDraw(VkCommandBuffer cmd_buffer, uint_t frame_index,
        std::shared_ptr<Geometry> geometry, [something] instance_buffer) const {
...
//}
//
//glm::mat4 MeshRenderer::GetTransform() const {
...
//
//
//BoundingBox MeshRenderer::GetBoundingBoxWorldSpace() const {
