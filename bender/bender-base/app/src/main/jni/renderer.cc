...
void Renderer::fillDefaultPipelineCreateInfo(VkGraphicsPipelineCreateInfo* pipeline_create_info) const {
  getDefaultStates().fillDefaultPipelineCreateInfo(pipeline_create_info);
}
