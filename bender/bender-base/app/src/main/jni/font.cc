...
void Font::drawString(std::string text, VkCommandBuffer commandBuffer, VkRenderPass render_pass,
                      uint_t frame_index) {
...
Font::Font(Renderer& renderer, std::shared_ptr<ShaderState> shaders,
    ...
    VkDeviceSize bufferSizeVertex = sizeof(float) * FONT_STRING_SIZE * 4 * 4;
