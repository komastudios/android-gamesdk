      ...
      while(fileName != nullptr) {
        ...
        for (auto obj : modelData) {
          ...
          if (loadedMaterials.find(mtlName) == loadedMaterials.end()) {
            ...
            std::vector<std::shared_ptr<Texture>> myTextures = {loadedTextures[currMTL.map_Kd],
                                                                loadedTextures[currMTL.map_Ks],
                                                                loadedTextures[currMTL.map_Ke],
                                                                loadedTextures[currMTL.map_Ns],
                                                                loadedTextures[currMTL.map_Bump]};
