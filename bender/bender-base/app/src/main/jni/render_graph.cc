...
std::vector<std::shared_ptr<Mesh>> RenderGraph::GetVisibleMeshes() {
  ...
  std::vector<std::shared_ptr<Mesh>> visible;
  ...
  std::sort(visible.begin(), visible.end(), [this](std::shared_ptr<Mesh> a, std::shared_ptr<Mesh> b) {
