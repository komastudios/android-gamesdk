...
namespace  {
  const std::vector<MeshVertex> vertex_tetrahedron = {
          {{0.000000f,  0.356822f,  0.934172f},  {-0.000000f, 0.356822f,  0.934172f},  {-0.356810f, 0.008188f,  -0.934141f}, {-0.019496f, 0.998506f, -0.051042f}, {0.250000f, 0.616140f}},
  ...
  const std::vector<MeshVertex> vertex_cube = {
          {{1.000000f,  -1.000000f, -1.000000f}, {0.333300f,  -0.333300f, -0.333300f}, {1.000000f,  0.000000f,  0.000000f},  {0.000000f,  1.000000f, 0.000000f},  {0.875000f, 0.304087f}},
  ...
  const std::vector<MeshVertex> vertex_octahedron = {
          {{-0.309017f, -0.500000f, 0.809017f},  {-0.309017f, -0.500000f, 0.809017f},  {-0.998587f, -0.049643f, 0.018962f},  {0.182903f,  0.918414f, -0.350803f}, {0.308070f, 0.333333f}},
  ...
  const std::vector<MeshVertex> vertex_dodecahedron = {
          {{0.000000f,  0.356822f,  0.934172f},  {-0.107677f, 0.522675f,  0.845705f},  {-0.981360f, 0.101035f,  -0.163478f}, {0.951057f,  0.162460f, -0.262866f}, {0.250000f, 0.616140f}},
  ...
  const std::vector<MeshVertex> vertex_icosahedron = {
          {{0.525731f,  0.000000f,  0.850651f},  {0.525731f,  0.000000f,  0.850651f},  {-0.670145f, -0.068883f, 0.739027f},  {-0.244607f, 0.796933f, -0.552327f}, {0.161896f, 0.500000f}},
...
std::vector<std::function<void(std::vector<MeshVertex>&, std::vector<uint16_t>&)>> polyhedronGenerators = {
    populateTetrahedron,
    populateCube,
    populateOctahedron,
