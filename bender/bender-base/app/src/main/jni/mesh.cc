...
Mesh::Mesh(BenderKit::Device *device, ShaderState *shaderState, std::vector<float> vertexData, std::vector<uint16_t> indexData) {
    device_ = device;
...
void Mesh::createPipeline() {
    ...
    CALL_VK(vkCreateGraphicsPipelines(device_->getDevice(), gfxPipeline.cache_, 1, &pipelineInfo,
