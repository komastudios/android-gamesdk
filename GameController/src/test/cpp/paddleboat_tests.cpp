...
static const Paddleboat_Controller_Mapping_Data pbtest_invalidmap_vendorid[] = {
        { 16, 0, 0x0010, 0x0002, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
          /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0,
          /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0 } },
        { 16, 0, 0x0020, 0x0002, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
          /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0,
          /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0 } },
        { 16, 0, 0x0018, 0x0002, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
          /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0,
          /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0 } },
        { 16, 0, 0x0030, 0x0002, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
...
static const Paddleboat_Controller_Mapping_Data pbtest_invalidmap_productid[] = {
        ...
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
          /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0,
          /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0 } },
        { 16, 0, 0x0020, 0x0001, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
...
static const Paddleboat_Controller_Mapping_Data pbtest_invalidmap_apilevel[] = {
        ...
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
          /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0,
          /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0 } },
        { 19, 0, 0x0020, 0x0001, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
...
static const Paddleboat_Controller_Mapping_Data pbtest_validmap[] = {
        ...
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
          /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0,
          /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0 } },
        { 19, 0, 0x0020, 0x0002, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
          /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0,
          /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0 } },
        { 16, 0, 0x0020, 0x0004, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
          /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0,
          /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0 } },
        { 16, 0, 0x0030, 0x0001, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
...
static const Paddleboat_Controller_Mapping_Data pbtest_add_entry1 = {
        16, 0, 0x0001, 0x0001, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
...
static const Paddleboat_Controller_Mapping_Data pbtest_add_entry2 = {
        16, 0, 0x0020, 0x0010, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
...
static const Paddleboat_Controller_Mapping_Data pbtest_add_entry3 = {
        16, 0, 0x0040, 0x0100, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */ 0, /* R2 */ 0, /* HX */ 0, /* HY */ 0 },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF },
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0, /* B      */ 0, /* X      */ 0,
...
static Paddleboat_Controller_Mapping_Data testMappingTable[TEST_MAPPING_TABLE_SIZE];

static void InitSearchFromExistingEntry(const Paddleboat_Controller_Mapping_Data* sourceEntry, MappingTableSearch& mapSearch) {
    mapSearch.initSearchParameters(sourceEntry->vendorId, sourceEntry->productId, sourceEntry->minimumEffectiveApiLevel, sourceEntry->maximumEffectiveApiLevel);
}
...
TEST(PaddleboatValidateMapVendorId, Validity)
{
    ...
    const Paddleboat_Controller_Mapping_Data* errorEntry = GameControllerMappingUtils::validateMapTable(pbtest_invalidmap_vendorid, entryCount);
...
TEST(PaddleboatValidateMapProductId, Validity)
{
    ...
    const Paddleboat_Controller_Mapping_Data* errorEntry = GameControllerMappingUtils::validateMapTable(pbtest_invalidmap_productid, entryCount);
    EXPECT_NE(errorEntry, nullptr);
...
TEST(PaddleboatValidateMapApiLevel, Validity)
{
    ...
    const Paddleboat_Controller_Mapping_Data* errorEntry = GameControllerMappingUtils::validateMapTable(pbtest_invalidmap_apilevel, entryCount);
    EXPECT_NE(errorEntry, nullptr);
    EXPECT_EQ(errorEntry->vendorId, 0x0020);
    EXPECT_EQ(errorEntry->productId, 0x0001);
...
TEST(PaddleboatValidateMapSuccess, Validity)
{
    ...
    const Paddleboat_Controller_Mapping_Data* errorEntry = GameControllerMappingUtils::validateMapTable(pbtest_validmap, entryCount);
...
{
    const int32_t entryCount = static_cast<const int32_t>(ARRAY_COUNTOF(pbtest_validmap));
    memcpy(testMappingTable, pbtest_validmap, entryCount * sizeof(Paddleboat_Controller_Mapping_Data));
...
{
    const int32_t entryCount = static_cast<const int32_t>(ARRAY_COUNTOF(pbtest_validmap));
    memset(testMappingTable, 0, TEST_MAPPING_TABLE_SIZE * sizeof(Paddleboat_Controller_Mapping_Data));
    memcpy(testMappingTable, pbtest_validmap, entryCount * sizeof(Paddleboat_Controller_Mapping_Data));
    MappingTableSearch mapSearch(&testMappingTable[0], entryCount);

    InitSearchFromExistingEntry(&pbtest_add_entry1, mapSearch);
    GameControllerMappingUtils::findMatchingMapEntry(&mapSearch);
    bool success = GameControllerMappingUtils::insertMapEntry(&pbtest_add_entry1, &mapSearch);
    ...
    GameControllerMappingUtils::findMatchingMapEntry(&mapSearch);
    success = GameControllerMappingUtils::insertMapEntry(&pbtest_add_entry2, &mapSearch);
    EXPECT_EQ(success, true);
    ...
    GameControllerMappingUtils::findMatchingMapEntry(&mapSearch);
    success = GameControllerMappingUtils::insertMapEntry(&pbtest_add_entry3, &mapSearch);
    EXPECT_EQ(success, true);
