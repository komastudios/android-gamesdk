...
static const Paddleboat_Controller_Mapping_Data pbtest_invalidmap_vendorid[] = {
        {16, 0, 0x0010, 0x0002, PADDLEBOAT_CONTROLLER_LAYOUT_STANDARD,
                ...
                { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF,
                  /* L2 */ 0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF},
                { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */ 0,
                  /* B      */ 0, /* X      */ 0, /* Y      */ 0, /* L1     */ 0, /* L2     */ 0,
                  /* L3     */ 0, /* R1     */ 0, /* R2     */ 0, /* R3     */ 0, /* SELECT */ 0,
                  /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0, 0, 0}},
...
static const Paddleboat_Controller_Mapping_Data pbtest_add_entry2 = {
        ...
        { /* LX */ 0, /* LY */ 0, /* RX */ 0, /* RY */ 0, /* L1 */ 0, /* L2 */ 0, /* R1 */
                   0, /* R2 */ 0, /* HX */ 0, /* HY */ 0},
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */
                   0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF},
        { /* LX */ 0xFF, /* LY */ 0xFF, /* RX */ 0xFF, /* RY */ 0xFF, /* L1 */ 0xFF, /* L2 */
                   0xFF, /* R1 */ 0xFF, /* R2 */ 0xFF, /* HX */ 0xFF, /* HY */ 0xFF},
        { /* UP     */ 0, /* LEFT   */ 0, /* DOWN   */ 0, /* RIGHT  */ 0, /* A      */
                       0, /* B      */ 0, /* X      */ 0,
                /* Y      */ 0, /* L1     */ 0, /* L2     */ 0, /* L3     */ 0, /* R1     */
                       0, /* R2     */ 0, /* R3     */ 0,
                /* SELECT */ 0, /* START  */ 0, /* SYSTEM */ 0, /* TOUCHP */ 0, /* AUX1-4 */ 0, 0,
                       0, 0}
...
static void InitSearchFromExistingEntry(const Paddleboat_Controller_Mapping_Data *sourceEntry,
...
const Paddleboat_Controller_Mapping_Data *errorEntry = GameControllerMappingUtils::validateMapTable(
        pbtest_invalidmap_vendorid, entryCount);
EXPECT_NE(errorEntry,
nullptr);
EXPECT_EQ(errorEntry
->vendorId, 0x0018);
}
...
const Paddleboat_Controller_Mapping_Data *errorEntry = GameControllerMappingUtils::validateMapTable(
        pbtest_invalidmap_apilevel, entryCount);
EXPECT_NE(errorEntry,
nullptr);
EXPECT_EQ(errorEntry
->vendorId, 0x0020);
...
{
const int32_t entryCount = static_cast<const int32_t>(ARRAY_COUNTOF(pbtest_validmap));
memset(testMappingTable,
0, TEST_MAPPING_TABLE_SIZE * sizeof(Paddleboat_Controller_Mapping_Data));
memcpy(testMappingTable, pbtest_validmap, entryCount
* sizeof(Paddleboat_Controller_Mapping_Data));
MappingTableSearch mapSearch(&testMappingTable[0], entryCount);
...
EXPECT_EQ(success,
true);
EXPECT_EQ(testMappingTable[0]
.vendorId, pbtest_add_entry1.vendorId);
EXPECT_EQ(testMappingTable[0]
.productId, pbtest_add_entry1.productId);
EXPECT_EQ(testMappingTable[6]
.vendorId, 0x30);
EXPECT_EQ(testMappingTable[6]
.productId, 0x1);
...
EXPECT_EQ(success,
true);
EXPECT_EQ(testMappingTable[5]
.vendorId, pbtest_add_entry2.vendorId);
EXPECT_EQ(testMappingTable[5]
.productId, pbtest_add_entry2.productId);
EXPECT_EQ(testMappingTable[6]
.vendorId, 0x30);
EXPECT_EQ(testMappingTable[6]
.productId, 0x1);
...
.productId, 0x1);
EXPECT_EQ(testMappingTable[6]
.vendorId, pbtest_add_entry3.vendorId);
EXPECT_EQ(testMappingTable[6]
.productId, pbtest_add_entry3.productId);
