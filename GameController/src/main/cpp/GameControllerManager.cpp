...
namespace paddleboat {
    ...
    Paddleboat_ErrorCode GameControllerManager::init(JNIEnv *env, jobject jcontext) {
        ...
        static const JNINativeMethod methods[] = {
                {"onControllerConnected", "([I[F[F[F[F)V", reinterpret_cast<void*>(Java_com_google_android_games_paddleboat_GameControllerManager_onControllerConnected)},
                ...
                {"onMouseConnected", "(I)V", reinterpret_cast<void*>(Java_com_google_android_games_paddleboat_GameControllerManager_onMouseConnected)},
        ...
        int rc = env->RegisterNatives(gcmClass, methods, sizeof(methods)/sizeof(JNINativeMethod));
        if (rc != JNI_OK) {
        ...
        if (gcmClassName != NULL) {
            env->DeleteLocalRef(gcmClassName);
        }
    ...
    GameControllerManager::GameControllerManager(JNIEnv *env, jobject jcontext, ConstructorTag) {
        ...
        const Paddleboat_Controller_Mapping_Data *mappingData = GetInternalControllerData();
