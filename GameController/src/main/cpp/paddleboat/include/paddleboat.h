 ...
 */
typedef struct Paddleboat_Controller_Mapping_File_Header {
    /** @brief Identifer value for the file, expected to be equal
 ...
 */
typedef struct Paddleboat_Controller_Mapping_File_Axis_Entry {
 ...
 */
 typedef struct Paddleboat_Controller_Mapping_File_Button_Entry {
    /** @brief Index into the file's string table for the entry
 ...
 */
typedef struct Paddleboat_Controller_Mapping_File_Controller_Entry {
    /** @brief Minimum API level required for this entry */
    int16_t minimumEffectiveApiLevel;
    /** @brief Maximum API level required for this entry, 0 = no max */
    int16_t maximumEffectiveApiLevel;
 ...
 */
 typedef struct Paddleboat_Controller_Mapping_File_String_Entry {
    /** @brief An ASCII string, expected to be 0 terminated.
     * Must fit, including termination in
     * `PADDLEBOAT_STRING_TABLE_ENTRY_MAX_SIZE`
     */
    const char stringTableEntry[PADDLEBOAT_STRING_TABLE_ENTRY_MAX_SIZE];
 ...
 * @deprecated Use `Paddleboat_addControllerRemapDataFromFileBuffer` instead.
 */
 ...
 * @param addMode The addition mode for the new data. See the
 * `Paddleboat_Remap_Addition_Mode` enum for details on each mode.
 * @param mappingFileHeader A pointer to a buffer containing a PaddleboatMappingTool
