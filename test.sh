...
for i in `seq 1 16`;
    do
        gcloud firebase test android run --type=game-loop \
            ...
            --device model=Nexus10,version=19 \
            --device model=Nexus10,version=21 \
            --device model=Nexus10,version=22 \
            ...
            --device model=Nexus7,version=22 \
            --device model=Nexus7_clone_16_9,version=23 \
            --device model=Nexus7_clone_16_9,version=24 \
            --device model=Nexus7_clone_16_9,version=25 \
            --device model=Nexus7_clone_16_9,version=26 \
            --device model=Nexus9,version=21 \
            --device model=Nexus9,version=22 \
            --device model=Nexus9,version=23 \
            --device model=Nexus9,version=24 \
            --device model=Nexus9,version=25 \
            --device model=NexusLowRes,version=23 \
