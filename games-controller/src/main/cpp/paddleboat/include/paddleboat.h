...
enum Paddleboat_ErrorCode : int32_t {
    ...
    /**
     * @brief A file I/O error occured when trying to read mapping data from the
     * file descriptor passed to ::Paddleboat_addControllerRemapDataFromFile
     */
 ...
 * @deprecated Use ::Paddleboat_addControllerRemapDataFromFile or
 ...
 * @return `PADDLEBOAT_NO_ERROR` if successful, otherwise an error code.
 */
Paddleboat_ErrorCode Paddleboat_addControllerRemapDataFromFile(
    const Paddleboat_Remap_Addition_Mode addMode,
