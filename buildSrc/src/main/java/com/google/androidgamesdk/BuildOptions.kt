...
data class BuildOptions(
    ...
    constructor(buildType: String, threadChecks: Boolean) :
        this(buildType, threadChecks, null, null, null)
    constructor(buildType: String, threadChecks: Boolean, stl: String) :
        this(buildType, threadChecks, stl, null, null)
