...
public class OrbitActivity extends AppCompatActivity implements Choreographer.FrameCallback, SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRefreshPeriodNanos = (long) (ONE_S_IN_NS / refreshRateHz);
        long appVsyncOffsetNanos = display.getAppVsyncOffsetNanos();
        long sfVsyncOffsetNanos = mRefreshPeriodNanos - (display.getPresentationDeadlineNanos() - ONE_MS_IN_NS);
        ...
        nInit(mRefreshPeriodNanos, appVsyncOffsetNanos, sfVsyncOffsetNanos);

        nSetPreference("refresh_period", String.valueOf(mRefreshPeriodNanos));
    }
