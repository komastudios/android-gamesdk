...
rm -rf tmp-aar/
unzip ../../out/outputs/aar/GameInput.aar -d tmp-aar/
...
pushd tmp-aar/
rm -rf ../../../out/outputs/aar/GameInput.aar
zip ../../../out/outputs/aar/GameInput.aar -r *
popd
rm -rf tmp-aar/
zipinfo ../../out/outputs/aar/GameInput.aar