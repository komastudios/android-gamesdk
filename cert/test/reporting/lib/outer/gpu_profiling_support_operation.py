...
#
"""Some devices support GPU profiling tools. This test verifies whether a
device supports this feature or not. This test requires Android GPU Inspector
(AGI) installed and in the environment path. For example:

export PATH=${PATH}:/opt/agi

At the time of this writing, AGI can only be installed from
