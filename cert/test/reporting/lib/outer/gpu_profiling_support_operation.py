...
#
"""Google is working with partners (notably Qualcomm, but others are joining)
to enable GPU profiling through a common front-end called Android GPU inspector
(AGI, https://gpuinspector.dev/).
