...
#
"""While the majority of tests run from an app inside the device, there might
be a few that need to run from the outside. At the time of this writing, F2.2
"Support for GPU profiling tools" is an example.
