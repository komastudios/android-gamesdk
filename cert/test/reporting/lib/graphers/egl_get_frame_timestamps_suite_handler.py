...
from lib.graphers.suite_handler import SuiteHandler, ReportContext
...
class EGLGetFrameTimestampsSuiteHandler(SuiteHandler):
    ...
    @classmethod
    def render_summarization_plot(cls, suites: List['Suite']) -> Optional[str]:
        return None
    ...
    def render_report(self, ctx: ReportContext) -> List[fmt.Item]:
        ...
        header = fmt.Header("Ye ol' header", 4)
