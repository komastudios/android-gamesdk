    ...
    def render_plot(self) -> str:
        ...
        for datum in my_data:
            ...
            if is_failure and not is_expected_failure:
                squared_mag = datum.get_custom_field_numeric("mediump_vec_normalization_result.squared_magnitude")
                errors.append(squared_mag)
        ...
        # print(f"[INFO] {errors} errors for report:{str(self.suite.file)}")
