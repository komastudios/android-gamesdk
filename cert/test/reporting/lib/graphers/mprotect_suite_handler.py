...
class MProtectSuiteHandler(SuiteHandler):
    ...
    def render_plot(self) -> str:
        ...
        if self.mprotect_score == 0:
            return "PASSED."
        if self.mprotect_score == 1:
            return "R/W protect fail."
        if self.mprotect_score == 2:
            return "Unexpected violation."
        if self.mprotect_score == 3:
            return "Read protect fail."
        if self.mprotect_score == 4:
            return "Missing violation."
        if self.mprotect_score == 5:
            return "Mem mapping fail."
        if self.mprotect_score == 6:
            return "Mem alloc fail."
        if self.mprotect_score == 7:
