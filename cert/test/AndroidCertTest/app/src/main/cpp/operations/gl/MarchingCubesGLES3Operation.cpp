...
struct sleep_configuration {
  ...
  WaitMethod method;
    ...
    mc::MarchingCubesThreadPool::SleepConfig ToSleepConfig() const {
    const auto mthd = [=](){
      switch (method){
        case WaitMethod::None:
          return mc::MarchingCubesThreadPool::SleepConfig::Method::None;
        case WaitMethod::Sleep:
          return mc::MarchingCubesThreadPool::SleepConfig::Method::Sleep;
        case WaitMethod::Spinlock:
          return mc::MarchingCubesThreadPool::SleepConfig::Method::Spinlock;
      }
    }();
    return mc::MarchingCubesThreadPool::SleepConfig{period, duration, mthd };
  }
};
