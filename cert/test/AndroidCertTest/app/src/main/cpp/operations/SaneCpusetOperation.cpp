...
inline auto ApplyCpusetToThisThread(const cpu_set_t *cpuset) {
  // To the question "why reinventing the wheel in this operation, calling UNIX
  // sched_setaffinity(...) instead of our higher level ancer::SetThreadAffinity() that does the
...
/**
 * This function contains the meat of this functional test. It receives a set of cores and sets
 * these for the invoking thread. It does it by applying core sched.h features (i.e., cpuset_t).
 *
