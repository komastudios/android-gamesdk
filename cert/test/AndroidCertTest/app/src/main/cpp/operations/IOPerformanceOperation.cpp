...
namespace {
    ...
    constexpr auto ToAffinity(ThreadSetup setup) {
        switch (setup) {
            case ThreadSetup::kBigCores: return ThreadAffinity::kBig;
            case ThreadSetup::kLittleCores: return ThreadAffinity::kLittle;
            case ThreadSetup::kMiddleCores: return ThreadAffinity::kMiddle;
