...
public:
   ...
   void OnGlContextReady() override {
       ...
       auto vertex_file = "Shaders/HalfFloatPrecisionGLES3Operation/shader.vsh";
       auto fragment_file = "Shaders/HalfFloatPrecisionGLES3Operation/shader.fsh";
   ...
   void OnHeartbeat(Duration elapsed) override {
       _color_offset += 16;
       if ( _color_offset > 255 ) { _color_offset = 0; }
   }
