...
namespace ancer {
    ...
    public:
        ...
        enum class Mode {
            /**
             * Run the operation in data gathering mode, e.g., it will record
             * profiling data at runtime, and return it when the test is done
             * and wait() is called
             */
                    DataGatherer,
            /**
             * Run the operation in Stressor mode; no logging or profiling is
    ...
    public:
         ...
         * @param operation_id name of the operation impl, e.g.,
         * "CalculatePIOperation" (minus "operations" namespace)
         * @param suite_id name of the suite this operation will be running in
         * @param mode the mode this operation should run in (see
         * BaseOperation::Mode)
    ...
    public:
         ...
         * @param duration the time to execute for when start() is called.
         * If 0, run continuously until stop() is called.
         * @param json_configuration the operation's domain-specific
        ...
        /**
         * Asynchronously start execution of the operation on a thread.
         * Operation will continue
         * until the specified execution duration times out, or until stop() is
         * called.
        ...
        /**
         * Wait (blocking) for execution to complete. If the operation has a > 0
         * duration, this will
         * block until the operation's execution has determined the duration has
         * expired, otherwise,
        ...
        /**
         * Invoked when the hosting android activity receives an OnTrimMemory
         * call
        ...
        /**
         * Flag that the operation is canceled. Implementations should monitor
         * this to quit their work.
         */
        virtual void Stop() {
        ...
        /**
         * Get current size of opengl context. If context isn't ready yet, this
         * will return (0,0)
         */
        glm::ivec2 GetGlContextSize() const {
            return glm::ivec2(
                    _width, _height);
        }
        ...
        [[nodiscard]] auto GetHeartbeatPeriod() const noexcept {
            return _heartbeat_period;
        }

        /**
         * This method will be called periodically while running at a rate set
         * via SetHeartbeatPeriod
         * @param delta The time since the completion of the last time this was
         * invoked.
         */
        ...
        T GetConfiguration() {
            try {
                ...
                FatalError(
                    ...
                    "Encounted an exception when reading the configuration: %s",
                    e.what());
            }
        }

        /**
         * @return the duration in this operation should run for, if it is a
         * Mode::DataGatherer.
         */
