...
namespace ancer {
    ...
    public:
        ...
        /**
         * Ignore the time taken to perform operation from average FPS calculation
         * @param operation an operation to perform whose execution time you don't want to affect fps calc
         */
         ...
         * @return time (in seconds) since last call to UpdateFps
         */
        float UpdateFps() {
