...
#define VK_ENUM_START(NAME) \
  static void NAME##_debug_print(const char * name, uint32_t depth, const NAME & v) { \
    const char * value =
#define VK_ENUM_VALUE(VALUE) \
    (v == VALUE) ? #VALUE :
#define VK_ENUM_END \
    "unknown"; \
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = %s", depth, debug_print_tabs, name, value); \
  }
...
#define VK_FLAGS_NO_VALUES(NAME) \
  static void NAME##s_debug_print(const char * name, uint32_t depth, NAME##s v) { \
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = %i", depth, debug_print_tabs, name, static_cast<uint32_t>(v)); \
  }

#define VK_FLAGS_START(NAME) \
  static void NAME##s_debug_print(const char * name, uint32_t depth, NAME##s v); \
  static void NAME##Bits_debug_print(const char * name, uint32_t depth, NAME##Bits v) { \
...
#define VK_STRUCT_START(NAME) \
  static void NAME##_debug_print_members(const char * name, uint32_t depth, const NAME & value); \
  static void NAME##_debug_print(const char * name, uint32_t depth, const NAME & value) { \
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s", depth, debug_print_tabs, name); \
    NAME##_debug_print_members(name, depth + 1, value); \
  } \
  static void NAME##_debug_print(const char * name, uint32_t depth, const NAME * value) { \
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = %p", depth, debug_print_tabs, name, value); \
    if(value != nullptr) { \
      NAME##_debug_print_members(name, depth + 1, *value); \
    } \
  } \
...
#define VK_STRUCT_MEMBER_ARRAY(TYPE, COUNT, NAME) \
    if(value.NAME == nullptr) { \
      Log::E(Log::Tag{"VulkanDebug"}, "%.*s" #NAME " = nullptr", depth, debug_print_tabs); \
    } else { \
      Log::E(Log::Tag{"VulkanDebug"}, "%.*s" #NAME " = %p", depth, debug_print_tabs, value.NAME); \
      char name[64] = { 0 }; \
...
#define VK_BASIC_TYPE(NAME, TYPE, FMT) \
  static void NAME##_debug_print(const char * name, uint32_t depth, TYPE value) { \
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = " FMT, depth, debug_print_tabs, name, value); \
  }
...
#define VK_OBJECT_TYPE(TYPE) \
  static void TYPE##_debug_print(const char * name, uint32_t depth, TYPE value) { \
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = %p", depth, debug_print_tabs, name, value); \
  }
#define VK_OBJECT_NON_DISPATCHABLE_TYPE(TYPE) \
  static void TYPE##_debug_print(const char * name, uint32_t depth, TYPE value) { \
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = %llx", depth, debug_print_tabs, name, (uint64_t)value); \
  }
...
static void VkBool32_debug_print(const char * name, uint32_t depth, VkBool32 value) {
  if(value == VK_TRUE) {
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = VK_TRUE", depth, debug_print_tabs, name);
  } else if(value == VK_FALSE) {
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = VK_FALSE", depth, debug_print_tabs, name);
  } else {
    Log::E(Log::Tag{"VulkanDebug"}, "%.*s%s = invalid(%i)", depth, debug_print_tabs, name, value);
  }
}
