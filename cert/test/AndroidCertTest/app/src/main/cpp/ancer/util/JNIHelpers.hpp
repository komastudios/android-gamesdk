 ...
 * to be intensive in resource consumption. Waiting until such this native
 ...
 * the official JNIEnv. It offers the exact same API but that DeleteLocalRef
 * function, provided that any local reference obtained from an instance of this
 * type is released when that instance is destroyed
 */
struct LocalJNIEnv {
