    ...
    JniCallInAttachedThread(
            [file_name, &text](JNIEnv* env) {
                ...
                jmethodID get_asset_helpers_mid = env->GetMethodID(
                        ...
                        "()Lcom/google/androidcerttest/util/SystemHelpers;");
    ...
    JniCallInAttachedThread(
            [&tex, &out_width, &out_height, &has_alpha, file_name](JNIEnv* env) {
                ...
                jclass java_cls = RetrieveClass(
                        env, activity,
                        "com/google/androidcerttest/util/SystemHelpers$TextureInformation");
    ...
    JniCallInAttachedThread(
            [&info](JNIEnv* env) {
                ...
                jmethodID get_memory_info_mid = env->GetMethodID(
                        ...
                        "()Lcom/google/androidcerttest/util/SystemHelpers$MemoryInformation;");
                ...
                jclass java_cls = RetrieveClass(
                        env, activity,
                        "com/google/androidcerttest/util/SystemHelpers$MemoryInformation");
