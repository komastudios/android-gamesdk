...
//     {
//         // Adds an item to a list. Requires report_writers::List
//         // [1, 2, 3]
//         w.AddItem(d.foo);
//         // Adds a named item. Requires report_writers::Struct
//         // { "foo":1, "bar":2, "baz":3 }
//         w.AddItem("foo", d.foo);
//         // Helpers to cut down on boilerplate & avoid typos.
//         w.AddItem(DATUM_MEMBER(d, foo));
//         ADD_DATUM_MEMBER(w, d, foo);
//     }
//
...
//        // As std::to_chars()
//        w.ToChars(5);
//        // Takes the string/character and adds it to the report.
//        w.Print("Foo");
//        // Takes the raw data and adds it to the report.
//        w.PrintData(buf, buf_size);
//    }
//==============================================================================
...
// TODO(tmillican@google.com): Relying on WriteDatum() for the numbers is to get
//  around issues with ToChars.
