...
class GzipAssetInflater {
 ...
 private:
  /**
   * Parses the asset header info in order to see if it's a valid deflated resource. If so, internal
   ...
   * gzip header doesn't have a fixed size. its own content determines its length.
   *
