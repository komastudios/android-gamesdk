...
Java_com_google_androidcerttest_util_NativeInvoker_runUnitTests(JNIEnv *env, jclass instance) {
...
Java_com_google_androidcerttest_util_NativeInvoker_initializeSuite(
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_shutdownSuite(JNIEnv* env, jclass instance) {
...
Java_com_google_androidcerttest_util_NativeInvoker_createOperation(
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_startOperation(
        JNIEnv* env, jclass instance,
        jint id,
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_stopOperation(
        JNIEnv* env, jclass instance,
        jint id) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_isOperationStopped(
        JNIEnv* env, jclass instance,
        jint id) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_waitForOperation(
        JNIEnv* env, jclass instance,
        jint id) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_onTrimMemory(
        JNIEnv* env, jclass instance,
        jint level) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_glSurfaceViewHost_1ContextReady(
        JNIEnv* env,
        jclass instance) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_glSurfaceViewHost_1Draw(
        JNIEnv* env,
        jclass instance) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_glSurfaceViewHost_1Resize(
        JNIEnv* env,
        jclass instance,
        jint width,
        jint height) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_swappyGLHost_1Init(
        JNIEnv* env, jclass instance,
        jobject activity) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_swappyGLHost_1SetSurface(
        JNIEnv* env,
        jclass instance,
        jobject surface,
        jint width,
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_swappyGLHost_1StartRenderer(
        JNIEnv* env,
        jclass instance) {
    ancer::GetFpsCalculator().Reset();
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_swappyGLHost_1StopRenderer(
        JNIEnv* env,
        jclass instance) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_swappyGLHost_1ClearSurface(
        JNIEnv* env,
        jclass instance) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_swappyGLHost_1SetAutoSwapInterval(
        JNIEnv* env,
        jclass instance,
        jboolean enabled) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_swappyGLHost_1GetSwappyStats(
        JNIEnv* env,
        jclass instance,
        jint stat,
        jint bin) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_openReportFile(
        JNIEnv* env, jclass instance,
...
extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_closeReportFile(JNIEnv* env, jclass instance) {
    reporting::CloseReportLog();
}

extern "C" JNIEXPORT void JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_writeToReportFile(
        JNIEnv* env, jclass instance,
...
Java_com_google_androidcerttest_util_NativeInvoker_getSteadyClockTimeNanos(JNIEnv *env, jclass instance) {
    auto n = ancer::SteadyClock::now();
    return static_cast<jlong>(n.time_since_epoch().count());
}

extern "C" JNIEXPORT jint JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_getCpuId(JNIEnv* env, jclass instance) {
    return sched_getcpu();
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_getThreadId(JNIEnv* env, jclass instance) {
    std::stringstream ss;
...
Java_com_google_androidcerttest_util_NativeInvoker_getCurrentFps(JNIEnv* env, jclass instance) {
    return ancer::GetFpsCalculator().GetAverageFps();
}

extern "C" JNIEXPORT jlong JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_getCurrentMinFrameTimeNs(JNIEnv *env,
                                                                            jclass instance) {
    return duration_cast<Nanoseconds>(ancer::GetFpsCalculator().GetMinFrameTime()).count();
}

extern "C" JNIEXPORT jlong JNICALL
Java_com_google_androidcerttest_util_NativeInvoker_getCurrentMaxFrameTimeNs(JNIEnv *env,
                                                                            jclass instance) {
