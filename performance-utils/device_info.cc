...
namespace {
typedef long long int int64;  // NOLINT could not find common header
...
void addGlConstsV3_0(device_info::gl& gl) {
  ...
  ::gl_util::glGetInteger64v =
    reinterpret_cast<::gl_util::MyTypeGlGetInteger64v>(
...
void addGlConstsV3_1(device_info::gl& gl) {
  ...
  ::gl_util::glGetIntegeri_v =
    reinterpret_cast<::gl_util::MyTypeGlGetIntegeri_v>(
...
int main() {
  ...
  if (glVerMajor >= 3) {
    ...
    ::gl_util::glGetStringi = reinterpret_cast<::gl_util::MyTypeGlGetstringi>(
