...
public class GameActivity
  ...
  protected native void onSoftwareKbVisibilityChangedNative(long handle, boolean visible);
  ...
  // From the text input Listener.
  @Override
  public void onSoftwareKbVisibilityChanged(boolean visible) {
    onSoftwareKbVisibilityChangedNative(mNativeHandle, visible);
  }
