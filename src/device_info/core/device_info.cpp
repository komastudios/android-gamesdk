...
void addOglConstsV2_0(androidgamesdk_deviceinfo_Info_OpenGl& proto,
...
void addOglConstsV3_0(androidgamesdk_deviceinfo_Info_OpenGl& proto,
                      ProtoDataHolder::OpenGl& dataHolder) {
...
void addOglConstsV3_1(androidgamesdk_deviceinfo_Info_OpenGl& proto) {
...
void addOglConstsV3_2(androidgamesdk_deviceinfo_Info_OpenGl& proto,
                      ProtoDataHolder::OpenGl& dataHolder) {
...
// returns number of errors
int addGl(androidgamesdk_deviceinfo_Info_OpenGl& proto,
...
bool protoEncodeCpuFreqs(pb_ostream_t* stream, const pb_field_t* field,
  ...
  for (int i = 0; i <= cpuFreqs.size; i++) {
    androidgamesdk_deviceinfo_Info_CpuCore core =
        androidgamesdk_deviceinfo_Info_CpuCore_init_zero;
    ...
    if (!pb_encode_submessage(
            stream, androidgamesdk_deviceinfo_Info_CpuCore_fields, &core))
      return false;
  }
  return true;
}
...
void addGlCompressedTexturesRendering(
    ...
    androidgamesdk_deviceinfo_Info_OpenGl& openglProto,
...
int createProto(androidgamesdk_deviceinfo_InfoWithErrors& proto,
                ProtoDataHolder& dataHolder) {
  int numErrors = 0;

  // Zero out everything in proto.
  proto = androidgamesdk_deviceinfo_InfoWithErrors_init_zero;

  proto.has_info = true;
  androidgamesdk_deviceinfo_Info& info = proto.info;
  ...
  if (numErrorsEgl == 0) {
    ...
    androidgamesdk_deviceinfo_Info_OpenGl& protoGl = info.open_gl;
