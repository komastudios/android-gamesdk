...
constexpr int64_t BYTES_IN_MEGABYTE = 1024 * 1024;
...
std::map<std::string, int64_t> MetricsProvider::GetActivityManagerValues() {
    ...
    metrics_map["MemoryClass"] =
        activity_manager_->getMemoryClass() * BYTES_IN_MEGABYTE;
    metrics_map["LargeMemoryClass"] =
        activity_manager_->getLargeMemoryClass() * BYTES_IN_MEGABYTE;
