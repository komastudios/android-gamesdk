...
class Object {
  public:
    ...
    Object CallSIOMethod(const char* name, const char* a, int b, const char* returnClass) {
        ...
        jobject o = obj_.CallObjectMethod(name, str.str().c_str(), NewString(a).J(), b);
        return Object(o);
    }
};
...
class URL : public Object {
  public:
    ...
    URL(const std::string& s)
            : Object("java/net/URL", "(Ljava/lang/String;)V", NewString(s).J()) {}
