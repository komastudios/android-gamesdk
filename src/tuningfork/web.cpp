...
TuningFork_ErrorCode WebRequest::Send(
    ...
    CHECK_FOR_JNI_EXCEPTION_AND_RETURN(TUNINGFORK_ERROR_JNI_EXCEPTION); // Malformed URL

    // Open connection and set properties
    java::net::HttpURLConnection connection(url.openConnection());
    CHECK_FOR_JNI_EXCEPTION_AND_RETURN(TUNINGFORK_ERROR_JNI_EXCEPTION);// IOException
