...
void SwappyTraceWrapper::PostWaitCallback(void* userPtr, uint64_t cpuTimeNs, uint64_t gpuTimeNs) {
    static uint64_t prevCpuTimeNs = 0;
    SwappyTraceWrapper *_this = (SwappyTraceWrapper *) userPtr;
...
void SwappyTraceWrapper::PostSwapBuffersCallback(void* userPtr, uint64_t /*desiredPresentationTimeMillis*/) {
    // We no longer record the swap time
}
