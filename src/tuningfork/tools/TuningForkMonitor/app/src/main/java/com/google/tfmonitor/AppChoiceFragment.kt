...
class AppChoiceAdapter(val myDataset: MonitorViewModel) : RecyclerView.Adapter<AppChoiceAdapter.ViewHolder>() {
    ...
    class ViewHolder(val type: ViewHolderType, val dataset: MonitorViewModel, v: View) : RecyclerView.ViewHolder(v), View.OnClickListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
                                    viewType: Int): AppChoiceAdapter.ViewHolder {
        // create a new view
        val (type, view) = if (viewType== ViewHolderType.ITEM.ordinal) {
            Pair(ViewHolderType.ITEM, LayoutInflater.from(parent.context)
                .inflate(R.layout.text_row_item, parent, false) as View)
        } else {
            Pair(ViewHolderType.HEADING, LayoutInflater.from(parent.context)
