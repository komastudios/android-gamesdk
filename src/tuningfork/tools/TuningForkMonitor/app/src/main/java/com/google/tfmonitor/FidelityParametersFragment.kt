...
class FidelityParametersAdapter(private val myDataset: MonitorViewModel) : RecyclerView.Adapter<FidelityParametersAdapter.ViewHolder>() {
...
//                )
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
                                    viewType: Int): FidelityParametersAdapter.ViewHolder {
        // create a new view
    ...
    private fun numFPs() = (myDataset.getActiveAppData()?.value?.desc?.fidelityParameters?.size ?: 0)
...
class FidelityParametersFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (view!=null) {
            recyclerView = view.findViewById<RecyclerView>(R.id.fidelity_parameters_recycler_view).apply {
