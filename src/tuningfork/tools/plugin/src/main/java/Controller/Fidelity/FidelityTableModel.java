...
public class FidelityTableModel extends AbstractTableModel {
  ...
  public FidelityTableModel(FidelityTabController controller, ProtoCompiler compiler)
      throws IOException, CompilationException {
    this.controller = controller;
    this.compiler = compiler;
    data = DataModelTransformer.initFidelityData(controller.getProjectPath(), compiler);
  }
