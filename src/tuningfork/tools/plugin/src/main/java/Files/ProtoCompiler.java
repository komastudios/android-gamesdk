...
public final class ProtoCompiler {
    ...
    private ProtoCompiler() {
        try {
            File temporaryFolderRoot = JarUtils.copyProtobufToTemporaryFolder(
                PathUtil.getJarPathForClass(ProtoCompiler.class),
                PROTO_FOLDER_PATH_RELATIVE_TO_JAR);
            protocBinary =
    ...
    public File encodeFromTextprotoFile(String message, File protoFile, String textprotoString,
        ...
        ProcessBuilder builder = new ProcessBuilder(command)
                                     .redirectInput(temporaryTextProtoFile)
                                     .redirectOutput(binFile);
