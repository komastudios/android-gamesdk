...
public class PluginLayout extends JPanel {
  ...
  public PluginLayout(String projectPath) throws IOException, CompilationException {
  ...
  private void initComponents() throws IOException, CompilationException {
    ...
    annotationsLayout = new AnnotationTab(new AnnotationTabController(projectPath));
    annotationsLayout.setSize(new Dimension(5 * SCREEN_SIZE.width / 6, SCREEN_SIZE.height / 2));
    annotationsLayout.setVisible(true);
    fidelitySettingsLayout = new FidelityTab(new FidelityTabController(projectPath));
