...
public class AnnotationTab extends TabLayout {
  ...
  public AnnotationTab(AnnotationTabController annotationController, ProtoCompiler compiler)
  ...
  private void initComponents() throws IOException, CompilationException {
    ...
    AnnotationTableModel model = new AnnotationTableModel(annotationController, compiler);
    ...
    this.add(scrollPane);
    this.add(new EnumTable(annotationController, compiler));
  }
