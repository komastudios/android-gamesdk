...
public class MainDialogWrapper extends DialogWrapper {
  ...
  private List<FidelityTableData> fidelityData;
  ...
  public MainDialogWrapper(@Nullable Project project, List<String[]> annotationData,
      List<FidelityTableData> fidelityData, List<String> enumData) {
    super(project);
