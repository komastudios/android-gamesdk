...
public class FidelityCellPanelValidationRendererWrapper extends CellRendererPanel implements
  ...
  public final Component getTableCellRendererComponent(JTable table, Object value,
    ...
    if (cellValidator != null) {
      ...
      if (validatablePanel instanceof FidelityValidatableTextField) {
        FidelityValidatableTextField validatableTextField
            = (FidelityValidatableTextField) validatablePanel;
