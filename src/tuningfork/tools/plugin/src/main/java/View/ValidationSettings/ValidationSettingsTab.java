...
public class ValidationSettingsTab extends TabLayout {
    ...
    private JBTable validationSetingsTable;
    ...
    private final JBLabel validationSetingsLabel = new JBLabel("Settings parameters");
    private final JBLabel informationLabel = new JBLabel("<html> Choose your prefered settings for game analysis. <br>" +
            "Histograms:</html>");
    ...
    private void initVariables() {
        ...
        validationSetingsTable = new JBTable();
        ...
        decoratorPanel =
                ToolbarDecorator.createDecorator(validationSetingsTable)
                        .setAddAction(it -> ValidationSettingsTabController.addRowAction(validationSetingsTable))
                        .setRemoveAction(it -> ValidationSettingsTabController.removeRowAction(validationSetingsTable))
                        .createPanel();
    }
    ...
    private void initComponents() {
        ...
        validationSetingsLabel.setFont(getMainFont());
        informationLabel.setFont(getSecondaryLabel());
        this.add(validationSetingsLabel);
        this.add(Box.createVerticalStrut(10));
        this.add(informationLabel);
        ValidationSettingsTableModel model = new ValidationSettingsTableModel();
        validationSetingsTable.setModel(model);
        setDecoratorPanelSize(decoratorPanel);
        setTableSettings(scrollPane, decoratorPanel, validationSetingsTable);
        this.add(scrollPane);
