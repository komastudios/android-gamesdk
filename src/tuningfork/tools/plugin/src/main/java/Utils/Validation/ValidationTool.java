...
public class ValidationTool {
  ...
  private static final ArrayList[] getQualityForOneField(
   ...
   */
  private static final List<String> getEnumIndexes(List<String> optionsToBeTransformed,
  ...
  private static final boolean hasZeroEnum(ArrayList<String> indexes) {
    return indexes.stream().filter(index -> index.equals("0")).collect(Collectors.toList()).size()
        > 0;
  }

  private static final void transformEnumOptionsToIndex(List<QualityDataModel> qualityDataModels,
