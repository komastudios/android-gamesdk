...
public class DevFidelityParamsLayout extends JPanel {
  ...
  private static JLabel aboutQualitySettings;
  private static JTable qualityParametersTable;
  private static QualityTableModel qualityTableModel;
  ...
  private void initComponents() {
    ...
    tablePanel = ToolbarDecorator.createDecorator(qualityParametersTable)
        .setAddAction(anActionButton -> qualityTableModel.addRow(qualityParametersTable))
        .setRemoveAction(
            anActionButton -> qualityTableModel.removeRow(qualityParametersTable.getSelectedRow()))
        .createPanel();
