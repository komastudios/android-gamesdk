...
public class GenerateAnnotationAction extends AnAction {
  ...
  public void actionPerformed(@NotNull AnActionEvent e) {
    ...
    ProgressManager.getInstance()
        .run(
            new Task.Backgroundable(e.getProject(), "Loading APT Data") {
              public void run(@NotNull ProgressIndicator progressIndicator) {
                ...
                try {
                  ...
                  progressIndicator.setText("Loading Up Methods");
                  WriteCommandAction.runWriteCommandAction(project, () -> {
                    tuningForkMethodsGeneration
                        .generateTuningForkCode(annotationData, fidelityData);
                  });
                  progressIndicator.setText("Brushing Up Imports");
                  WriteCommandAction.runWriteCommandAction(project, () -> {
                    OCImportSymbolFix.fixAllSymbolsRecursively(psiFile);
                  });
