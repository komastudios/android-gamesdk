...
public class OpenPluginAction extends AnAction {
  private static final ProtoCompiler PROTO_COMPILER = ProtoCompiler.getInstance();

  @Override
  public void actionPerformed(@NotNull AnActionEvent e) {
    MainDialogWrapper mainDialogWrapper = new MainDialogWrapper(e.getProject(), PROTO_COMPILER);
