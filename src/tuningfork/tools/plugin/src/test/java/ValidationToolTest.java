...
public class ValidationToolTest {
  ...
  public void correctDevFidelityParams() {
    ...
    assert(errors.getWarningCount() == 0);
  }
  ...
  public void enumZero() {
    ...
    assert(errors.getWarningCount(ErrorType.DEV_FIDELITY_PARAMETERS_ENUMS_ZERO) > 0);
  }
  ...
  public void incorrectOrder() {
    ...
    assert(errors.getWarningCount(ErrorType.DEV_FIDELITY_PARAMETERS_ORDER) == 1);
  }
}
