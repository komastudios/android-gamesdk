...
public:
    virtual ~Backend() {};
    virtual TuningFork_ErrorCode Process(const std::string& tuningfork_log_event) = 0;
};
...
class Request {
  ...
  public:
    ...
    virtual TuningFork_ErrorCode Send(const std::string& rpc_name, const std::string& request,
...
public:
    ...
    virtual TuningFork_ErrorCode GetFidelityParams(Request& request,
