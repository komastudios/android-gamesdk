...
TuningFork_ErrorCode TuningFork_init_internal(const TuningFork_Settings *c_settings_in, JNIEnv* env,
                                     jobject context) {
...
TuningFork_ErrorCode TuningFork_getFidelityParameters(const TuningFork_CProtobufSerialization *default_params,
...
TuningFork_ErrorCode TuningFork_frameDeltaTimeNanos(TuningFork_InstrumentKey id, TuningFork_Duration dt) {
