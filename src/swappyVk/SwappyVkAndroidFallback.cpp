 ...
 */
#ifdef ANDROID
SwappyVkAndroidFallback::SwappyVkAndroidFallback(VkPhysicalDevice physicalDevice,
                                                  VkDevice         device,
                                                  SwappyVk         &swappyVk,
                                                  void             *libVulkan) :
...
SwappyVkAndroidFallback::~SwappyVkAndroidFallback() {
    stopChoreographerThread();
}

bool SwappyVkAndroidFallback::doGetRefreshCycleDuration(VkSwapchainKHR swapchain,
...
VkResult SwappyVkAndroidFallback::doQueuePresent(VkQueue                 queue,
