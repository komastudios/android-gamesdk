...
// If you make your classes available on the Java classpath, e.g. through your
// engine's own Java component, you do not need to add the binary resource and
// can instead define ANDROIDGAMESDK_NO_BINARY_DEX_LINKAGE which will avoid
// the linker requiring these symbols.
