...
const std::vector<CpuInfo::Cpu>& CpuInfo::cores() const {
    return mCpus;
}

const std::string CpuInfo::hardware() const {
    return mHardware;
}

cpu_set_t CpuInfo::littleCoresMask() const {
    return mLittleCoresMask;
}

cpu_set_t CpuInfo::bigCoresMask() const {
