...
public:
    NDKChoreographerThread(ChoreographerThreadCallback onChoreographer);
...
NDKChoreographerThread::NDKChoreographerThread(ChoreographerThreadCallback onChoreographer) :
...
public:
    JavaChoreographerThread(JavaVM *vm, ChoreographerThreadCallback onChoreographer);
...
JavaChoreographerThread::JavaChoreographerThread(JavaVM *vm,
                                                 ChoreographerThreadCallback onChoreographer) :
        ChoreographerThread(onChoreographer),
        mJVM(vm)
{
...
public:
    NoChoreographerThread(ChoreographerThreadCallback onChoreographer);
...
NoChoreographerThread::NoChoreographerThread(ChoreographerThreadCallback onChoreographer) :
    ChoreographerThread(onChoreographer) {}
...
ChoreographerThread::ChoreographerThread(ChoreographerThreadCallback onChoreographer):
