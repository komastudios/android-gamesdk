...
ChoreographerThread::ChoreographerThread(JavaVM *vm,
    ...
    jclass choreographerManagerClass = env->FindClass("com/google/swappy/ChoreographerManager");

    jmethodID constructor = env->GetMethodID(
            choreographerManagerClass,
            "<init>",
            "(J)V");
    ...
    jobject choreographerManager = env->NewObject(choreographerManagerClass, constructor, reinterpret_cast<jlong>(this));

    mChorMan = env->NewGlobalRef(choreographerManager);
}
...
Java_com_google_swappy_ChoreographerManager_nOnChoreographer(JNIEnv * /* env */, jobject /* this */,
                                                                jlong cookie, jlong frameTimeNanos) {
    ChoreographerManager::onChoreographer(cookie);
}
