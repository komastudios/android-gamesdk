    ...
    if (!swappy->mUsingExternalChoreographer) {
        ...
        swappy->mChoreographerThread =
                ChoreographerThreadFactory::createChoreographerThread(
                        ChoreographerThreadFactory::APP_CHOREOGRAPHER,
                        nullptr,
...
Swappy::Swappy(JavaVM *vm,
    ...
    : mRefreshPeriod(refreshPeriod),
      ...
      mChoreographerThread(ChoreographerThreadFactory::createChoreographerThread(
              ChoreographerThreadFactory::SWAPPY_CHOREOGRAPHER,
              vm,
