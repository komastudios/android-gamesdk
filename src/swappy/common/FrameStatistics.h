...
class MinimalFrameStatistics : public FrameStatistics {
   public:
    MinimalFrameStatistics(const EGL& egl, const SwappyCommon& swappyCommon);
    ~MinimalFrameStatistics() = default;
...
class FullFrameStatistics : public MinimalFrameStatistics {
   public:
