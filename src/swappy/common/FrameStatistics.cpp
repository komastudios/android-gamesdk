...
int32_t LatencyFrameStatistics::getFrameDelta(EGLnsecsANDROID start,
                                              EGLnsecsANDROID end) {
...
LatencyFrameStatistics::LatencyFrameStatistics(const EGL& egl,
                                               const SwappyCommon& swappyCommon)
    : mEgl(egl), mSwappyCommon(swappyCommon) {}

void LatencyFrameStatistics::updateLatency(
...
LatencyFrameStatistics::ThisFrame LatencyFrameStatistics::getThisFrame(
...
void LatencyFrameStatistics::capture(EGLDisplay dpy, EGLSurface surface) {
...
FullFrameStatistics::FullFrameStatistics(const EGL& egl,
                                         const SwappyCommon& swappyCommon)
    : LatencyFrameStatistics(egl, swappyCommon) {}
