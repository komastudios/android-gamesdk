...
bool SwappyCommon::updateSwapInterval() {
    ...
    std::pair<std::chrono::nanoseconds, int> lowerRefreshMap;
    ...
    if (mayNeedRefreshChange) {
        ...
        TRACE_INT("preferredRefreshPeriod", lowerRefreshMap.first.count());
        setPreferredRefreshRate(lowerRefreshMap.second);
    }
