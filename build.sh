...
then
    ...
    ./gradlew packageZip -Plibraries=swappy,tuningfork,oboe,game_activity,game_text_input,game_controller -PincludeSampleSources -PincludeSampleArtifacts -PdistPath="$dist_dir" -PpackageName=$package_name
    ...
    ./gradlew jetpadJson -Plibraries=swappy,tuningfork,game_activity,game_text_input,game_controller -PdistPath="$dist_dir" -PpackageName=$package_name
elif [[ $1 == "samples" ]]
then
    ...
    package_name=gamesdk
    ./gradlew packageZip -Plibraries=swappy,tuningfork,oboe,game_activity,game_text_input,game_controller -PincludeSampleSources -PdistPath="$dist_dir"
    ./gradlew packageMavenZip -Plibraries=swappy -PdistPath="$dist_dir" -PpackageName=$package_name
    ./gradlew packageMavenZip -Plibraries=tuningfork -PdistPath="$dist_dir" -PpackageName=$package_name
    ./gradlew packageMavenZip -Plibraries=oboe -PdistPath="$dist_dir" -PpackageName=$package_name
    ./gradlew packageMavenZip -Plibraries=game_activity -PdistPath="$dist_dir" -PpackageName=$package_name
