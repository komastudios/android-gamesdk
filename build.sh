...
then
    ...
    zip -ur $dist_dir/$package_name/agdk-libraries-*.zip "samples/tuningfork/common"
    zip -ur $dist_dir/$package_name/agdk-libraries-*.zip "third_party/protobuf-3.0.0/"
    zip -ur $dist_dir/$package_name/agdk-libraries-*.zip "games-performance-tuner/proto"
    zip -ur $dist_dir/$package_name/agdk-libraries-*.zip "games-performance-tuner/protobuf"
    pushd ..
    zip -ur $dist_dir/$package_name/agdk-libraries-*.zip "external/nanopb-c"
    popd
fi
