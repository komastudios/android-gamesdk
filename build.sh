...
then
    ...
    zip -ur agdk-libraries-*.zip game-activity-release.aar
    zip -ur agdk-libraries-*.zip game-text-input-release.aar
    zip -ur agdk-libraries-*.zip games-controller-release.aar
    zip -ur agdk-libraries-*.zip games-frame-pacing-release.aar
    zip -ur agdk-libraries-*.zip games-performance-tuner-release.aar
    popd
