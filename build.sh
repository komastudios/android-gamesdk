...
then
    ...
    echo "Tom: pwd"
    pwd
    zip -ur agdk-libraries-.zip "samples/tuningfork/insightsdemo/" -x "samples/tuningfork/insightsdemo/.idea/*"\
      "samples/tuningfork/insightsdemo/app/build/*" "samples/tuningfork/insightsdemo/app/.cxx/*"\
      "samples/tuningfork/insightsdemo/.gradle/*" "samples/tuningfork/insightsdemo/gradle*"
fi
