...
public class GameActivity
    extends AppCompatActivity implements SurfaceHolder.Callback2, OnGlobalLayoutListener, Listener {
  ...
  protected class InputEnabledSurfaceView extends SurfaceView {
    ...
    public InputEnabledSurfaceView(GameActivity context) {
      ...
      mInputConnection =
          new InputConnection(context, this, new Settings(editorInfo)).setListener(context);
    }
