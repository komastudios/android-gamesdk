...
public class GameActivity extends AppCompatActivity implements SurfaceHolder.Callback2,
    ...
    private native long loadNativeCode(String path, String funcname,
     ...
     */
    public long getGameActivityNativeHandle() { return this.mNativeHandle; }
    ...
    protected void onCreateSurfaceView() {
        ...
        mSurfaceView.getHolder().addCallback(this); // Register as a callback for the rendering of the surface, so that we can pass this surface to the native code
    }
    ...
    protected class InputEnabledSurfaceView extends SurfaceView {
        ...
        public InputEnabledSurfaceView(GameActivity context) {
            ...
            // TODO (willosborn): these need to be set-able externally.
...
//            editorInfo.inputType = InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_FLAG_AUTO_COMPLETE;
            editorInfo.inputType = InputType.TYPE_NULL; // For keys only
            editorInfo.actionId = IME_ACTION_NONE;
            mInputConnection = new InputConnection(context, this, new Settings(editorInfo)).setListener(context);
        }
