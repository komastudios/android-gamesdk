  ...
  public MemoryWatcher(
    ...
    runner = new Runnable() {
      ...
      public void run() {
        ...
        // (in milliseconds), plus the estimated run time for the next iteration.
        long timeRequired = (totalTimeSpent + duration) * 1000 / maxMillisecondsPerSecond;
        ...
        long sleepFor = timeRequired - timeSinceStart;
        if (sleepFor < 1) {
