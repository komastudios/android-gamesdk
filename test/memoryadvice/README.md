...
[Google's Maven repository](https://maven.google.com/web/index.html?q=com.google.android.games#com.google.android.games:memory-advice:0.23).
...
dependencies {
    // ..
    implementation 'com.google.android.games:memory-advice:0.23'
