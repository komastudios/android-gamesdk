...
class Collector {
  ...
  public static final String FIELDS =
      "nextPageToken,steps(stepId,dimensionValue,testExecutionStep(toolExecution(toolOutputs,toolLogs)))";
  ...
  static void cloudCollect(Consumer<? super JSONArray> emitter) throws IOException {
    ...
    for (History history : historiesResponse.getHistories()) {
          ...
          while (true) {
            ...
            for (Step step : response1.getSteps()) {
              ...
              for (ToolOutputReference toolOutputReference : toolOutputs) {
                ...
                break; // Only get the first output.
              }
            }
      ...
      break; // Only do most recent history.
    }
  }
